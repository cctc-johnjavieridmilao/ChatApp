                        ...
                        <div class="modal-dialog w-100 mx-auto">
                            <div class="modal-content">
                                <div class="modal-body">
                                    ...
                                    <form class="">
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="position-relative form-group">
                                                    <input name="password" id="cpassword" placeholder="Confirm Password"
                                                        type="password" class="form-control"></div>
                                            </div>
                                        </div>
                                ...
                                <div class="modal-footer clearfix">
                                    <div class="float-left"><a href="index.php"
                                            class="btn-lg btn btn-link">Back</a></div>
                                    <div class="float-right">
                                        <button class="btn btn-primary btn-lg" onclick="Register()" id="RegUser">Register</button>
                                    </div>
                                </div>
                            </div>
                        </div>
